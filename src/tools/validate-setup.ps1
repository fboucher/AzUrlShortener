...
Test-NotPlaceholder -Name "TenantId" -Value $TenantId
Test-NotPlaceholder -Name "ResourceGroupName" -Value $ResourceGroupName
Test-NotPlaceholder -Name "AdminContainerAppName" -Value $AdminContainerAppName
Test-NotPlaceholder -Name "ApiContainerAppName" -Value $ApiContainerAppName
Test-NotPlaceholder -Name "AdminAppClientId" -Value $AdminAppClientId
Test-NotPlaceholder -Name "ApiAppClientId" -Value $ApiAppClientId
Test-NotPlaceholder -Name "ManagedIdentityClientId" -Value $ManagedIdentityClientId
Test-NotPlaceholder -Name "ManagedIdentityPrincipalId" -Value $ManagedIdentityPrincipalId
Test-NotPlaceholder -Name "ExpectedFederatedCredentialName" -Value $ExpectedFederatedCredentialName
Test-NotPlaceholder -Name "ExpectedFederatedAudience" -Value $ExpectedFederatedAudience
